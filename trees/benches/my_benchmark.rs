 ...
 */
 ...
 fn criterion_benchmark(c: &mut Criterion) {
     ...
     let num_limit = 130000; // 10,000, 40,000, 70,000, 100,000, 130,000
    ...
    //  c.bench_function("AVL tree insert: ", |b| {
    //      b.iter(|| {
    ...
    //  });
     ...
     let lower_test_values_known: Vec<_> = lower_test_values_known
         ...
         .cloned()
         .collect();
     c.bench_function("AVL tree search known: ", |b| {
         b.iter(|| {
    ...
    //      .collect();
    //  c.bench_function("AVL tree search unknown: ", |b| {
    //      b.iter(|| {
